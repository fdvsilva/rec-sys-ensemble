# -----------------------------------------------------------------------------
#
# The code presented below turns off back propagations for the missing ratings,
# otherwise the network would learn to predict all values as -100, because that
# value represents the missing values.
# -----------------------------------------------------------------------------
